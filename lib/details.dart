...
class Fulldata extends StatefulWidget {
  ...
  Fulldata({Key key, this.id}) : super(key: key);
...
//  }
  ...
  Future<Autogenerated> lyric(int id) async {
    final response = await http.get(
    ...
    if (response.statusCode == 200) {
      ...
      // then parse the JSON.
      print(json.decode(response.body));
      return Autogenerated2.fromJson(json.decode(response.body));
    } else {
      // If the server did not return a 200 OK response,
      // then throw an exception.
      throw Exception('Failed to load album');
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              FutureBuilder<Autogenerated2>(
                future: lyric(widget.id),
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    return Column(
                      children: [
                        ...
                        Text('${snapshot.data.message.body}')
                      ],
                    );
                  } else if (snapshot.hasError) {
                    return Text("${snapshot.error}");
...
class Message2 {
  ...
  Message2({this.header, this.body});
...
class Header2 {
  ...
  Header2({this.statusCode, this.executeTime});

  Header2.fromJson(Map<String, dynamic> json) {
...
class Body2 {
  ...
  Body2.fromJson(Map<String, dynamic> json) {
    lyrics =
    json['lyrics'] != null ? new Lyrics2.fromJson(json['lyrics']) : null;
  }
...
class Lyrics2 {
  ...
  Lyrics2.fromJson(Map<String, dynamic> json) {
